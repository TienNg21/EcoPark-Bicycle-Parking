...
adminRouter.get('/', async (req,res) => {
    if (req.user == null || req.user.email !== process.env.EMAIL_ADMIN){
        ...
        const lsu = await pool.query('select id, ngay_thue as ngay_thue, bat_dau, ket_thuc, id_user, id_xe, id_bai_xe_thue, id_bai_xe_tra, thanh_tien from lich_su_thue_xe lstx order by lstx.ngay_thue asc ');
